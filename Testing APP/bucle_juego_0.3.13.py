...
while game is True:
    ...
    for jugador in lista_jugadores[1::]:
        if (dict_jugadores[lista_jugadores[0]]['puntos_mano'] >= dict_jugadores[jugador]['puntos_mano'] and
            dict_jugadores[lista_jugadores[0]]['mano'] != 'eliminado') or (
    ...
    for jugador in lista_jugadores[1::]:
        if (dict_jugadores[lista_jugadores[0]]['puntos_mano'] < dict_jugadores[jugador]['puntos_mano'] or
            dict_jugadores[lista_jugadores[0]]['mano'] == 'eliminado') and dict_jugadores[jugador][
            'mano'] != 'eliminado':
    ...
    if len(lista_jugadores) == 1:
        print(f'¡Enhorabuena {lista_jugadores[0]}! Has eliminado a los demás jugadores ¡Eres el ganador!')
        game = False
    if turno == 30:
...
'''
    En esta version del bucle.
        1) Hemos añadido la eliminacion de los jugadores sin puntos al final de ronda
        2) hemos establecido la condicion de victoria por eliminacion de los demas jugadores
        3) Hemos movido la condicion de fin de juego por turno 30 al final en lugar del principio del bucle.
        4) Impresion del informe de final de partida en turno 30 ( HAY QUE MEJORAR CON UN BUBBLE SORT SEGUN PUNTUACIONES)

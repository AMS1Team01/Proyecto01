...
# loop Banca
    ...
    if dict_jugadores[lista_jugadores[0]]['mano'] == 'eliminado':
        ...
        if dict_jugadores[lista_jugadores[0]]["puntos_mano"] == 7.5:
            ...
            for jugador in lista_jugadores[1::]:
                ...
                dict_jugadores[jugador]["puntos_restantes"] -= dict_jugadores[jugador]["apuesta"]
                print(f'{jugador} pierde {dict_jugadores[jugador]["apuesta"]} puntos.')
            print(f'La banca ahroa tiene {dict_jugadores[lista_jugadores[0]]["puntos_restantes"]} puntos')
        elif dict_jugadores[lista_jugadores[0]]["puntos_mano"] != 7.5:
            for jugador in lista_jugadores[1::]:
    ...
    '''
    si todos los jugadores se han pasado banca no juega y gana ---- HECHO
        bucle cobra todas las apuestas  ---- Hecho
    la banca juega--------- Hecho
    si banca se pasa ------ Hecho
        bucle comprobar si jugador juega----------Hecho
            si jugador juega la banca le paga  ------ Hecho
    si no se han pasado banca juega ----------------------Hecho
        si saca 7.5 gana a todos -----------------Hecho
            bucle cobra todas las apuestas --------Hecho
        si no saca 7.5 comparamos ------------- hecho
            si jugador se ha pasado ---------------hecho
                paga a la banca ------------hecho
            si jugador no se ha pasado --------------hecho
                si banca gana ------------------hecho
                    paga a la banca -------------hecho
                si banca no gana ---------------hecho
                    si jugador 7.5 ------------hecho
                        paga doble al jugador ------------hecho
                    si jugador no 7.5 ------------hecho
                        paga al jugador -------------hecho
...
# Comprobaciones estado y comparacion puntos para resolver apuestas.
    ...
    # En este bucle se ha redefinido la comprobacion de puntuaciones y los resultados

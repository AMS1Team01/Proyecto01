...
while game is True:
    ...
    # Si quedan jugadores la banca juga:
        ...
        # En esta version comprobamos primero las opciones
    ...
    for jugador in lista_jugadores[1::]:
        ...
        elif (dict_jugadores[lista_jugadores[0]]['puntos_mano'] < dict_jugadores[jugador]['puntos_mano'] or
        ...
        # Luego efectuamos los prints según el caso qeu se haya dado en la partida
...
'''
    En esta version del bucle.
        1) Se establece que la apuesta de un jugador no puede ser mayor que los puntos restantes del jugador.
        2) Se ha añadido una comprobacion para que la banca no pueda pagar mas puntos de los que tiene.
'''

...
# loop Banca
    ...
    for jugador in lista_jugadores[1::]:
        if dict_jugadores[lista_jugadores[0]]['puntos_mano'] >= dict_jugadores[jugador]['puntos_mano'] and dict_jugadores[lista_jugadores[0]]['mano'] != 'eliminado':
            dict_jugadores[lista_jugadores[0]]["puntos_restantes"] += dict_jugadores[jugador]["apuesta"]
            dict_jugadores[jugador]["puntos_restantes"] -= dict_jugadores[jugador]["apuesta"]
...
# Comprobaciones estado y comparacion puntos para resolver apuestas.
    ...
    # En este bucle se ha separado la comprobacion de puntuaciones y impresion de resultados.
    # Se ha separado en 2 funcionalidades independientes, comprobaciones y prints para intentar ganar espacio y
    # poder encapsularlo en funciones mas adelante.
